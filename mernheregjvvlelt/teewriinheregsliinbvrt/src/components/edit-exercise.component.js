    ...
    axios.get('http://localhost:5000/exercises/'+this.props.match.params.id)
      .then(response => {
        this.setState({
          ...
          carmark: response.data.carmark,
          ownerovog: response.data.ownerovog,
          ownerner: response.data.ownerner,
          ownerrd: response.data.ownerrd,
          ownerphone: response.data.ownerphone,
          uildon: response.data.uildon
        })   
      })
  ...
  render() {
    ...
    <div>
      ...
      <div className="form-group"> 
        ...
        <div className="form-group">
          <input type="submit" value="Бүртгэл засах" className="btn btn-primary" />
        </div>
      </form>
    </div>
    )
